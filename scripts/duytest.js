(function () {
    ...
    mainActivityView: {
      ...
      profileView: {
        ...
        menteeView: {
          ...
          basicInfo: document.querySelector(
            "#profile .mentee .profile-card__form"
          ),
          myMentorView: document.querySelector(
            "#profile .mentee .profile-card__content-my-mentor"
          ),
        },
        mentorView: {
          generalView: document.querySelector("#profile .mentor"),
          basicInfo: document.querySelector(
            "#profile .mentor .profile-card__form"
          ),
          myMenteesView: document.querySelector(
            "#profile .mentor .profile-card__my-mentees"
          ),
          pendingMenteesView: document.querySelector(
      ...
      evaluationView: {
        ...
        menteeView: {
          ...
          generalEvaluationView: document.querySelector(
            "#evaluation .mentee .evaluation-card__general"
          ),
          evaluationHistoryView: document.querySelector(
            "#evaluation .mentee .evaluation__history"
          ),
        },
        mentorView: {
          generalView: document.querySelector("#evaluation .mentor"),
          addEntryView: document.querySelector(
            "#evaluation .mentor .evaluation-card__add-history"
          ),
          generalEvaluationView: document.querySelector(
      ...
      searchView: {
        ...
        searchFieldView: document.querySelector(
          "#search .mentee .search-card__input-field"
        ),
        searchResultsView: document.querySelector(
          "#search .mentee .search-card__results"
        ),
        applicationFormView: {
          generalView: document.querySelector(
            "#search .mentee .search-card__application-form"
          ),
          form: document.querySelector("#search .mentee .search-card__form"),
        },
        mentorView: {
          generalView: document.querySelector(
            "#search .search-card__mentor-profile"
          ),
          ...
          disconnectView: document.querySelector(
            "#search .profile-card__disconnect"
          ),
        },
      },
    },
  ...
  document
    .querySelector("#signup .auth-card__auth")
  ...
  document
    .querySelector("#login .auth-card__signup-btn")
  ...
  document
    .querySelector("#signup .auth-card__login-btn")
    .addEventListener("click", function () {
  ...
  document
    .querySelector("#login .auth-card__auth")
    .addEventListener("click", function (e) {
      e.preventDefault();
          ...
          app
            ...
            .then(function (doc) {
              ...
              if (app.user.role === "mentee") {
                app.mainActivityView.newsFeedView.menteeView.generalView.style.display =
                  "block";
                app.mainActivityView.newsFeedView.mentorView.generalView.style.display =
                  "none";
  ...
  document
    .querySelector(".profile-card__logout-btn")
    .addEventListener("click", function () {
      auth.signOut();
      app.reset();
    });
  ...
  document
    .querySelector("#signup-mentee")
    .addEventListener("click", function () {
      app.toggleSignUpRoleInputField("mentee");
    });

  document
    .querySelector("#signup-mentor")
    .addEventListener("click", function () {
      app.toggleSignUpRoleInputField("mentor");
    });

  document
    .querySelector(".search-card__mentor-profile .profile-card__back-btn")
    .addEventListener("click", function (e) {
      e.preventDefault();

      app.mainActivityView.searchView.mentorView.generalView.style.display =
        "none";
      ...
      document
        .querySelectorAll(".profile-card__info")
  ...
  document
    .querySelector(".profile-card__connect-btn")
    .addEventListener("click", function (e) {
      e.preventDefault();

      app.mainActivityView.searchView.mentorView.generalView.style.display =
        "none";
      app.mainActivityView.searchView.applicationFormView.generalView.style.display =
        "block";
    });

  /* Event listener for discard application form */
  document
    .querySelector(".search-card__discard-btn")
    .addEventListener("click", function (e) {
      e.preventDefault();
  ...
  document
    .querySelector(".search-card__submit-btn")
    .addEventListener("click", function (e) {
      e.preventDefault();

      var essay =
        app.mainActivityView.searchView.applicationFormView.form.essay.value;
      app.user.requestConnection(essay);
      app.mainActivityView.searchView.mentorView.generalView.style.display =
        "block";
      app.mainActivityView.searchView.mentorView.requestView.style.display =
        "none";
      app.mainActivityView.searchView.mentorView.disconnectView.style.display =
        "none";
      app.mainActivityView.searchView.mentorView.pendingView.style.display =
        "block";
      app.mainActivityView.searchView.applicationFormView.generalView.style.display =
        "none";
    });
  ...
  document
    .querySelector(".search-card__search-btn")
    .addEventListener("click", function (e) {
      e.preventDefault();
  ...
  document
    .querySelector("#evaluation .mentor .fa-plus-circle")
    .addEventListener("click", function () {
      app.mainActivityView.evaluationView.mentorView.addEntryView.style.display =
        "block";
    });

  /* Event listener for cancel adding history entry */
  document
    .querySelector("#evaluation .mentor .btn__left")
    .addEventListener("click", function (e) {
      e.preventDefault();
  ...
  document
    .querySelector("#evaluation .mentor .btn__right")
    .addEventListener("click", function (e) {
      e.preventDefault();

      var date =
        app.mainActivityView.evaluationView.mentorView.addEntryView[
          "history-date"
        ].value;
      var positivity =
        app.mainActivityView.evaluationView.mentorView.addEntryView[
      ...
      db.collection("users")
        .doc(app.user.basicInfo.email)
        .set(app.user, { merge: true })
        .then(function () {
          db.collection("users")
            .doc(self.mentees[0].basicInfo.email)
            .set(self.mentees[0], { merge: true })
            .then(function () {
              console.log("Success");
              app.mainActivityView.evaluationView.mentorView.addEntryView[
                "history-date"
        ...
        localforage
          ...
          .then(function (value) {
            ...
            if (app.user.role === "mentee") {
              ...
              app.mainActivityView.newsFeedView.mentorView.generalView.style.display =
                "none";
              app.mainActivityView.profileView.menteeView.generalView.style.display =
                "block";
              app.mainActivityView.evaluationView.menteeView.generalView.style.display =
                "block";
              app.mainActivityView.profileView.mentorView.generalView.style.display =
                "none";
              app.mainActivityView.evaluationView.mentorView.generalView.style.display =
                "none";
            } else if (app.user.role === "mentor") {
              app.mainActivityView.newsFeedView.menteeView.generalView.style.display =
                "none";
  ...
  app.reset = function () {
    ...
    while (
      app.mainActivityView.profileView.menteeView.myMentorView.firstChild
    ) {
      app.mainActivityView.profileView.menteeView.myMentorView.removeChild(
        app.mainActivityView.profileView.menteeView.myMentorView.lastChild
      );
    }
  ...
  app.setUpEvaluation = function () {
    ...
    if (app.user.role === "mentor") {
      for (
        var i = 0;
        i < app.user.mentees[0].mentors[0].evaluations.length;
        i++
      ) {
        app.createEvalResult(app.user.mentees[0].mentors[0].evaluations[i], i);
      }
      ...
      .onSnapshot(function (doc) {
        if (app.user.role === "mentee") {
          while (
            ...
            app.mainActivityView.evaluationView.menteeView.generalEvaluationView.removeChild(
              app.mainActivityView.evaluationView.menteeView
          ...
          while (
            ...
            app.mainActivityView.evaluationView.mentorView.generalEvaluationView.removeChild(
              app.mainActivityView.evaluationView.mentorView
                .generalEvaluationView.lastChild
            );
          }
        }

        var updatedMenteeEval =
          app.user.role === "mentee"
            ? doc.data().mentors[0]
            : doc.data().mentees[0].mentors[0];
        var updatedLength = updatedMenteeEval.evaluations.length;
        var currentLength =
          app.user.role === "mentee"
            ? app.user.mentors[0].evaluations.length
            : app.user.mentees[0].mentors[0].evaluations.length;

        if (updatedLength === currentLength) {
          app.createEvalResult(
            updatedMenteeEval.evaluations[updatedLength - 1],
            updatedLength - 1
          );

          if (app.user.role === "mentee") {
            app.user.mentors[0].evaluations.push(
              updatedMenteeEval.evaluations[updatedLength - 1]
            );
          } else if (app.user.role === "mentor") {
            app.user.mentees[0].mentors[0].evaluations.push(
              updatedMenteeEval.evaluations[updatedLength - 1]
            );
          }
        ...
        for (var i = currentLength; i < updatedLength; i++) {
          ...
          if (app.user.role === "mentee") {
            app.user.mentors[0].evaluations.push(
              updatedMenteeEval.evaluations[i]
            );
          } else if (app.user.role === "mentor") {
            app.user.mentees[0].mentors[0].evaluations.push(
              updatedMenteeEval.evaluations[i]
  ...
  app.createGeneralEval = function () {
    ...
    if (app.user.role === "mentee") {
      app.mainActivityView.evaluationView.menteeView.generalEvaluationView.appendChild(
        title
      );
      app.mainActivityView.evaluationView.menteeView.generalEvaluationView.appendChild(
        generalChart
      ...
      app.mainActivityView.evaluationView.mentorView.generalEvaluationView.appendChild(
        title
      );
      app.mainActivityView.evaluationView.mentorView.generalEvaluationView.appendChild(
        generalChart
  ...
  app.createEvalResult = function (evaluation, pos) {
    ...
    if (app.user.role === "mentee") {
      app.mainActivityView.evaluationView.menteeView.evaluationHistoryView.appendChild(
        historyItem
      );
    } else if (app.user.role === "mentor") {
      app.mainActivityView.evaluationView.mentorView.evaluationHistoryView.appendChild(
        historyItem
      );
    }
  ...
  app.setUpUserInfo = function () {
    ...
    if (app.user.role === "mentee") {
      ...
      app.mainActivityView.profileView.menteeView.basicInfo.fullname.setAttribute(
        "placeholder",
        app.user.basicInfo.fullname
      );
      app.mainActivityView.profileView.menteeView.basicInfo.age.setAttribute(
        "placeholder",
        app.user.basicInfo.age
      );
      app.mainActivityView.profileView.menteeView.basicInfo.cellphone.setAttribute(
        "placeholder",
        app.user.basicInfo.cellphone
      );
      app.mainActivityView.profileView.menteeView.basicInfo.position.setAttribute(
        "placeholder",
        app.user.school
      );
      ...
      app.mainActivityView.profileView.mentorView.basicInfo.fullname.setAttribute(
        "placeholder",
        app.user.basicInfo.fullname
      );
      app.mainActivityView.profileView.mentorView.basicInfo.age.setAttribute(
        "placeholder",
        app.user.basicInfo.age
      );
      app.mainActivityView.profileView.mentorView.basicInfo.cellphone.setAttribute(
        "placeholder",
        app.user.basicInfo.cellphone
      );
      app.mainActivityView.profileView.mentorView.basicInfo.position.setAttribute(
        "placeholder",
        app.user.job
      );
    ...
    db.collection("users")
      ...
      .then(function (doc) {
        ...
        myMentorEvaluate.addEventListener("click", function (e) {
          ...
          console.log(
            app.mainActivityView.evaluationView.menteeView.generalView
          );
          ...
          app.mainActivityView.profileView.generalView.style.display = "none";
          app.mainActivityView.evaluationView.generalView.style.display =
            "block";
          app.mainActivityView.evaluationView.mentorView.generalView.style.display =
            "none";
          app.mainActivityView.evaluationView.menteeView.generalView.style.display =
        ...
        app.mainActivityView.profileView.menteeView.myMentorView.appendChild(
          myMentorCard
        );
      })
      .catch(function (error) {
  ...
  app.createPendingMentee = function (value, index) {
    ...
    pendingMenteeAnswer.setAttribute(
      "class",
      "profile-card__pending-mentee__info"
    );
    pendingMenteeQuestion.setAttribute(
      "class",
      "profile-card__pending-mentee__info profile-card__pending-mentee__info--bold"
    );
    pendingMenteeIntroName.setAttribute(
      "class",
      "profile-card__info profile-card__info--bold"
    );
    ...
    pendingMenteeImage.setAttribute(
      "src",
      "https://icatcare.org/app/uploads/2018/06/Layer-1704-1920x840.jpg"
    );
    ...
    pendingMenteeDecline.addEventListener("click", function (e) {
      ...
      app.user.handlePendingConnectionRequest("decline", {
        mentee: value.mentee,
        index: index,
      });

      app.mainActivityView.profileView.mentorView.pendingMenteesView.removeChild(
        pendingMenteeCard
      );
    });
    ...
    pendingMenteeAccept.addEventListener("click", function (e) {
      ...
      app.user.handlePendingConnectionRequest("accept", {
        mentee: value.mentee,
        index: index,
      });
    ...
    app.mainActivityView.profileView.mentorView.pendingMenteesView.appendChild(
      pendingMenteeCard
    );
  };
  ...
  app.createMyMentee = function (mentee) {
    ...
    app.mainActivityView.profileView.mentorView.myMenteesView.appendChild(
      myMenteeCard
    );
  };
  ...
  app.setUserPrivilege = function () {
    if (app.user.role === "mentee") {
      app.user.requestConnection = function (essay) {
        ...
        db.collection("users")
          .doc(app.selectedMentor.basicInfo.email)
          .set(app.selectedMentor, { merge: true });
      };
      ...
      app.user._accept = function (request) {
        ...
        request.mentee.mentors.push({
          email: thisMentor.basicInfo.email,
          evaluations: [],
        });

        db.collection("users")
          .doc(thisMentor.basicInfo.email)
          .set(thisMentor, { merge: true });
        db.collection("users")
          .doc(request.mentee.basicInfo.email)
          .set(request.mentee, { merge: true });
      };
  ...
  app.removeAllSearchResults = function () {
    while (app.mainActivityView.searchView.searchResultsView.firstChild) {
      app.mainActivityView.searchView.searchResultsView.removeChild(
        app.mainActivityView.searchView.searchResultsView.lastChild
      );
    }
  };
  ...
  app.createSearchResult = function (mentor) {
    ...
    searchCardContent.setAttribute(
      "class",
      "search-card__content search-card__content--flex"
    );
    searchCardContentImage.setAttribute("class", "search-card__img");
    searchCardContentImage.setAttribute(
      "src",
      "https://icatcare.org/app/uploads/2018/06/Layer-1704-1920x840.jpg"
    );
    searchCardContentMentor.setAttribute("class", "search-card__mentor");
    searchCardContentMentorName.setAttribute(
      "class",
      "search-card__mentor-name"
    );
    searchCardContentMentorJob.setAttribute("class", "search-card__mentor-job");
    searchCardContentMentorConnect.setAttribute(
      "class",
      "search-card__connect-btn profile-card__connect-btn"
    );
    ...
    searchCard.addEventListener("click", function (e) {
      ...
      if (e.target.tagName === "BUTTON") {
        ...
        if (
          app.mainActivityView.searchView.mentorView.generalView.style
            .display === "block"
        ) {
          app.mainActivityView.searchView.mentorView.generalView.style.display =
            "none";
        ...
        app.mainActivityView.searchView.searchResultsView.style.display =
          "none";
        app.mainActivityView.searchView.applicationFormView.generalView.style.display =
          "block";
      ...
      document
        ...
        .forEach(function (value) {
          if (value.textContent.includes("Full name")) {
            value.textContent =
              value.textContent + mentorInfo.basicInfo.fullname;
          } else if (value.textContent.includes("Age")) {
            value.textContent = value.textContent + mentorInfo.basicInfo.age;
          } else if (value.textContent.includes("Cellphone")) {
            value.textContent =
              value.textContent + mentorInfo.basicInfo.cellphone;
          } else if (value.textContent.includes("Bio")) {
            value.textContent = value.textContent.concat(
              mentor.basicInfo.bio || ""
            );
          }
        });
  ...
  app.search = function (query) {
    if (query["mentor-name"].value !== "" && query["mentor-job"].value === "") {
      return db
        .collection("users")
        .where("role", "==", "mentor")
        .where("basicInfo.fullname", "==", query["mentor-name"].value)
        .get();
    } else if (
      query["mentor-name"].value === "" &&
      query["mentor-job"].value !== ""
    ) {
      return db
        .collection("users")
        .where("role", "==", "mentor")
        .where("job", "==", query["mentor-job"].value)
        .get();
    } else {
      return db
        .collection("users")
...
commandManager.execute(new LogOutCommand());
commandManager.execute(new SignUpCommand("vandijk@gmail.com", "123456", user));
commandManager.execute(new LogInCommand("vandijk@gmail.com", "123456"));

setTimeout(function () {
  commandManager.execute(new EvaluateCommand("23/04/2020", 12, 12, 12, "Good"));
}, 10000);

setTimeout(function () {
  var mentor = null;
  commandManager.execute(new SearchCommand("vandijk", ""));
  setTimeout(function () {
    mentor = commandManager.data.searchedMentors[0];
    commandManager.execute(new ConnectCommand(mentor));
    setTimeout(function () {
      mentor = new Mentor(
        mentor.name,
        mentor.age,
        mentor.email,
        mentor.role,
        mentor.pendingConnection,
        mentor.connection,
        mentor.jobTitle
      );
      mentor.handleRequestedConnection("accept");
